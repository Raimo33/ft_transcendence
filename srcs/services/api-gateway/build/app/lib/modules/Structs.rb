...
#    Updated: 2024/11/06 21:14:30 by craimond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
module Structs
  ...
  Resource = Struct.new(:path_template, :http_method, :expected_auth, :expected_request, :expected_responses, :operation_id)
end